...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mon Nov 3 21:31:19 2014
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/project_pugliesi1.0.0/ && $(COPY_FILE) --parents lib/EmptyQueueException.h lib/LoginWindow.h lib/Map.h lib/MapImpl.h lib/MergeSort.h lib/MergeSortImpl.h lib/Movie.h lib/Netflix.h lib/Node.h lib/NodeImp.h lib/NoSuchElementException.h lib/Pair.h lib/Queue.h lib/QueueImpl.h lib/Set.h lib/SetImpl.h lib/SignUpWindow.h lib/User.h .tmp/project_pugliesi1.0.0/ && $(COPY_FILE) --parents main.cpp lib/LoginWindow.cpp lib/Movie.cpp lib/Netflix.cpp lib/SignUpWindow.cpp lib/User.cpp .tmp/project_pugliesi1.0.0/ && (cd `dirname .tmp/project_pugliesi1.0.0` && $(TAR) project_pugliesi1.0.0.tar project_pugliesi1.0.0 && $(COMPRESS) project_pugliesi1.0.0.tar) && $(MOVE) `dirname .tmp/project_pugliesi1.0.0`/project_pugliesi1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/project_pugliesi1.0.0
...
compiler_moc_header_make_all: moc_LoginWindow.cpp moc_SignUpWindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_LoginWindow.cpp moc_SignUpWindow.cpp
...
moc_SignUpWindow.cpp: lib/SignUpWindow.h
