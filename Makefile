...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mon Nov 3 21:00:15 2014
...
all: Makefile project.app/Contents/PkgInfo project.app/Contents/Resources/empty.lproj project.app/Contents/Info.plist $(TARGET)

$(TARGET):  $(OBJECTS)  
	@$(CHK_DIR_EXISTS) project.app/Contents/MacOS/ || $(MKDIR) project.app/Contents/MacOS/ 
...
project.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) project.app/Contents || $(MKDIR) project.app/Contents 
	@$(DEL_FILE) project.app/Contents/PkgInfo
	@echo "APPL????" >project.app/Contents/PkgInfo
project.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) project.app/Contents/Resources || $(MKDIR) project.app/Contents/Resources 
	@touch project.app/Contents/Resources/empty.lproj
	
project.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) project.app/Contents || $(MKDIR) project.app/Contents 
	@$(DEL_FILE) project.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,project,g" -e "s,@TYPEINFO@,????,g" /usr/local/Cellar/qt/4.8.5/mkspecs/unsupported/macx-clang-libc++/Info.plist.app >project.app/Contents/Info.plist
dist: 
	@$(CHK_DIR_EXISTS) .tmp/project1.0.0 || $(MKDIR) .tmp/project1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/project1.0.0/ && $(COPY_FILE) --parents lib/EmptyQueueException.h lib/LoginWindow.h lib/Map.h lib/MapImpl.h lib/MergeSort.h lib/MergeSortImpl.h lib/Movie.h lib/Netflix.h lib/Node.h lib/NodeImp.h lib/NoSuchElementException.h lib/Pair.h lib/Queue.h lib/QueueImpl.h lib/Set.h lib/SetImpl.h lib/User.h .tmp/project1.0.0/ && $(COPY_FILE) --parents main.cpp lib/LoginWindow.cpp lib/Movie.cpp lib/Netflix.cpp lib/User.cpp .tmp/project1.0.0/ && (cd `dirname .tmp/project1.0.0` && $(TAR) project1.0.0.tar project1.0.0 && $(COMPRESS) project1.0.0.tar) && $(MOVE) `dirname .tmp/project1.0.0`/project1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/project1.0.0
...
compiler_moc_header_make_all: moc_LoginWindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_LoginWindow.cpp
moc_LoginWindow.cpp: lib/LoginWindow.h
