...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sun Dec 7 12:15:20 2014
...
SOURCES       = main.cpp \
		...
		lib/User.cpp moc_BaconGameWindow.cpp \
		moc_LoginWindow.cpp \
		moc_MainWindow.cpp \
		moc_RatingWindow.cpp \
		moc_RecommendationWindow.cpp \
...
OBJECTS       = main.o \
		...
		Netflix.o \
		RatingWindow.o \
		RecommendationWindow.o \
		SearchResultsWindow.o \
		SignUpWindow.o \
		User.o \
		moc_BaconGameWindow.o \
		moc_LoginWindow.o \
		moc_MainWindow.o \
		moc_RatingWindow.o \
		moc_RecommendationWindow.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/project_pugliesi1.0.0/ && $(COPY_FILE) --parents lib/Actor.h lib/BaconGameWindow.h lib/EmptyQueueException.h lib/LoginWindow.h lib/MainWindow.h lib/MergeSort.h lib/MergeSortImpl.h lib/Movie.h lib/Netflix.h lib/Node.h lib/NodeImp.h lib/NoSuchElementException.h lib/PairPrioritize.h lib/RatingWindow.h lib/RecommendationWindow.h lib/SearchResultsWindow.h lib/SignUpWindow.h lib/User.h .tmp/project_pugliesi1.0.0/ && $(COPY_FILE) --parents main.cpp lib/BaconGameWindow.cpp lib/LoginWindow.cpp lib/MainWindow.cpp lib/Movie.cpp lib/Netflix.cpp lib/RatingWindow.cpp lib/RecommendationWindow.cpp lib/SearchResultsWindow.cpp lib/SignUpWindow.cpp lib/User.cpp .tmp/project_pugliesi1.0.0/ && (cd `dirname .tmp/project_pugliesi1.0.0` && $(TAR) project_pugliesi1.0.0.tar project_pugliesi1.0.0 && $(COMPRESS) project_pugliesi1.0.0.tar) && $(MOVE) `dirname .tmp/project_pugliesi1.0.0`/project_pugliesi1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/project_pugliesi1.0.0
...
compiler_moc_header_make_all: moc_BaconGameWindow.cpp moc_LoginWindow.cpp moc_MainWindow.cpp moc_RatingWindow.cpp moc_RecommendationWindow.cpp moc_SearchResultsWindow.cpp moc_SignUpWindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_BaconGameWindow.cpp moc_LoginWindow.cpp moc_MainWindow.cpp moc_RatingWindow.cpp moc_RecommendationWindow.cpp moc_SearchResultsWindow.cpp moc_SignUpWindow.cpp
moc_BaconGameWindow.cpp: lib/Movie.h \
		lib/Netflix.h \
		lib/User.h \
		lib/Actor.h \
		lib/BaconGameWindow.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) lib/BaconGameWindow.h -o moc_BaconGameWindow.cpp
...
moc_RecommendationWindow.cpp: lib/Movie.h \
		lib/Netflix.h \
		lib/User.h \
		lib/Actor.h \
		lib/RecommendationWindow.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) lib/RecommendationWindow.h -o moc_RecommendationWindow.cpp
...
BaconGameWindow.o: lib/BaconGameWindow.cpp lib/BaconGameWindow.h \
		lib/Movie.h \
		lib/Netflix.h \
		lib/User.h \
		lib/Actor.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o BaconGameWindow.o lib/BaconGameWindow.cpp
...
RecommendationWindow.o: lib/RecommendationWindow.cpp lib/RecommendationWindow.h \
		lib/Movie.h \
		lib/Netflix.h \
		lib/User.h \
		lib/Actor.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o RecommendationWindow.o lib/RecommendationWindow.cpp
...
moc_BaconGameWindow.o: moc_BaconGameWindow.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_BaconGameWindow.o moc_BaconGameWindow.cpp
...
moc_RecommendationWindow.o: moc_RecommendationWindow.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_RecommendationWindow.o moc_RecommendationWindow.cpp
