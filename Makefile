...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed Nov 5 14:43:56 2014
...
moc_SearchResultsWindow.cpp: lib/Netflix.h \
		...
		lib/EmptyQueueException.h \
		lib/SearchResultsWindow.h
	/usr/local/Cellar/qt/4.8.5/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ lib/SearchResultsWindow.h -o moc_SearchResultsWindow.cpp
